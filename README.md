...
| AI - ChatGPT      | [javascript](ai/chatgpt/javascript/README.md), [dotnet](ai/chatgpt/dotnet/README.md), [python](ai/chatgpt/python/README.md) | Uses OpenAPI ChatGPT models to enable chat and multiple other prompt styles|
