...
namespace AI_Functions
{
    public class chat_function
    {
        ...
        private static readonly string OPENAI_API_URL =
            Environment.GetEnvironmentVariable("OPENAI_API_URL") ?? "https://api.openai.com";
        ...
        )
        {
            ...
            try
            {
                ...
                var completion = await OpenAICreateCompletion(
                    "text-davinci-003",
        ...
        static async Task<CompletionResponse> OpenAICreateCompletion(
            string model,
            string prompt,
            decimal temperature,
            int max_tokens,
        ...
        )
        {
            ...
            var completion = CompletionRequest.CreateDefaultCompletionRequest(
                model,
                prompt,
                temperature,
                max_tokens
